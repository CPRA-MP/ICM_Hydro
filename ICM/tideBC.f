...
!				BCnosurge(jj,2)=TideData(use_row,nnn)
                  BCnosurge(jj,2) = BCnosurge(jj,1)                     ! yw
     &            +(TideData(use_row+1,nnn)-TideData(use_row,nnn))      ! yw
     &            /lasttidestep                                         ! yw
      ...
      !            write (*,*) 'jj = ',jj
      !            write (*,*) 'nnn = ',nnn
      !            write (*,*) 'use_row = ',use_row
      !write (*,*) 'TideData(use_row+1,nnn) = ',TideData(use_row+1,nnn)
      !write (*,*) 'TideData(use_row,nnn) = ',TideData(use_row,nnn)
      !            write (*,*) 'lasttidestep = ',lasttidestep
      !            write (*,*) 'tidestep  = ',tidestep
      !        write (*,*) 'Surge(surgerow,jjk)  = ',Surge(surgerow,jjk)
      !            write (*,*) 'ES(jj,2)  = ',ES(jj,2)
      !            endif
			endif
		enddo
	end do
