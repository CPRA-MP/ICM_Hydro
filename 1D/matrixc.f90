subroutine matrixc()
    ...
    do i=1,ncomp
        ...
        b11(i)=0.5-phi-theta*cour*a(1,1)+0.5*thes*st(1,1)*dt_1d(i)
        b12(i)=-theta*cour*a(1,2)+0.5*thes*st(1,2)*dt_1d(i)
        b21(i)=-theta*cour*a(2,1)+0.5*thes*st(2,1)*dt_1d(i)
        b22(i)=0.5-phi-theta*cour*a(2,2)+0.5*thes*st(2,2)*dt_1d(i)
        ...
        !Nazmul: *dt_1d(i) is multiplied to all g matrix terms
        g(1,1)=0.5+phi+theta*cour*a(1,1)+0.5*thes*st(1,1)*dt_1d(i)
        g(1,2)=theta*cour*a(1,2)+0.5*thes*st(1,2)*dt_1d(i)
        g(2,1)=theta*cour*a(2,1)+0.5*thes*st(2,1)*dt_1d(i)
        g(2,2)=0.5+phi+theta*cour*a(2,2)+0.5*thes*st(2,2)*dt_1d(i)
